...
# All eleven tables in worker/database/schema.py, which is the authority. This list
...
tables = [
    ...
    ("publish_events", "One row per publish attempt, per receipt per destination. 10f.36"),
